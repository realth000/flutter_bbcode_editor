...
class BBCodeTextField extends StatefulWidget {
  ...
  @override
  State<BBCodeTextField> createState() => _BBCodeTextFieldState();
}

class _BBCodeTextFieldState extends State<BBCodeTextField> {
