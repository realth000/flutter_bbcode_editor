...
class BBCodeEditingDeltaHistoryView extends StatelessWidget {
  const BBCodeEditingDeltaHistoryView({super.key});
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return _buildTextEditingDeltaHistoryViews(
                  manager.bbcodeState.textEditingDeltaHistory)[index];
            },
            itemCount: manager.bbcodeState.textEditingDeltaHistory.length,
