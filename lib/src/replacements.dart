...
///
/// This used in [BBCodeEditController] to generate [InlineSpan]s when
...
/// See also:
///
/// * [BBCodeEditController], which uses this class to create
/// rich text fields.
/// {@end-tool}
...
class BBCodeEditController extends TextEditingController {
  ...
  BBCodeEditController.fromValue(super.value,
      {List<TextEditingInlineSpanReplacement>? replacements,
      this.composingRegionReplaceable = true})
      : super.fromValue();
