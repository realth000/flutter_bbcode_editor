...
class BasicTextInputClientState extends State<BasicTextInputClient>
  ...
  late BBCodeScopeWidgetState manager;
  ...
  void didChangeDependencies() {
    ...
    manager = BBCodeScopeWidget.of(context);
  }
  ...
  void updateEditingValueWithDeltas(List<TextEditingDelta> textEditingDeltas) {
    ...
    if (widget.controller is BBCodeEditController) {
      for (final TextEditingDelta delta in textEditingDeltas) {
        (widget.controller as BBCodeEditController)
    ...
    if (selectionChanged) {
      manager.updateToggleButtonsStateOnSelectionChanged(
          value.selection, widget.controller as BBCodeEditController);
    }
  }
  ...
  void _handleFocusChanged() {
    ...
    if (_hasFocus) {
      if (!_value.selection.isValid) {
        ...
        manager.updateToggleButtonsStateOnSelectionChanged(
            validSelection, widget.controller as BBCodeEditController);
      }
    }
  }
  ...
  void userUpdateTextEditingValue(
    ...
    if (selectionChanged) {
      ...
      if (selectionRangeChanged) {
        manager.updateToggleButtonsStateOnSelectionChanged(
            _value.selection, widget.controller as BBCodeEditController);
      }
    }
  }
